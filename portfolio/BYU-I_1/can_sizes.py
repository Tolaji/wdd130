...
def main():
    ...
    for can in can_sizes:
        ...
        print(f"Can: {can['name']}, Storage Efficiency: {storage_efficiency:.2f}")

        if storage_efficiency > highest_efficiency:
            highest_efficiency = storage_efficiency
            best_can = can['name']

    print(f"\nThe can with the highest storage efficiency is: {best_can}, with an efficiency of {highest_efficiency:.2f}")
